...
post "/" do
  begin
    ...
    elsif params[:text].match(/^jeopard(y|ize) (me|us|him|her|them|tina|matt|jack|slobodan)/i)
...
def question_words
  /^(what|whats|where|wheres|who|whos|when|whens|why|whys|how|hows|which|it's giving|its giving) /i
end
